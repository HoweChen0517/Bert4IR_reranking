...
from utils import write_trec_run
...
parser.add_argument(
    "--q", type=str, default="data/neural_ir/test_queries.tsv", help="path to queries"
)
parser.add_argument(
    "--run",
    type=str,
    default="data/neural_ir/test_bm25.trec",
...
parser.add_argument(
    "--checkpoint",
    default="output/teacher/ms-marco-MiniLM-L6-v2",
    type=str,
    help="path to model checkpoint",
)
parser.add_argument(
    "--o", type=str, default="output/teacher/test_run.trec", help="path to output run file",
)
